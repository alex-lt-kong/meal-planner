...
var Reminder = /*#__PURE__*/function (_React$Component) {
  ...
  function Reminder(props) {
    ...
    _this.handleClickMessageBoxOK = _this.handleClickMessageBoxOK.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Reminder, [{
    ...
    value: function fetchDataFromServer() {
      ...
      axios.get('https://monitor.sz.lan/meal-planner/get-reminder-message/').then(function (response) {
        _this2.setState({
      ...
      axios.get('https://monitor.sz.lan/meal-planner/get-consecutive-a-days/').then(function (response) {
        _this2.setState({
        ...
        console.log(_this2.state.consecutiveAData);
      })["catch"](function (error) {
        alert('加载全A天数失败！\n' + error);
      });
    }
    ...
    value: function render() {
      if (this.state.reminderData === null || this.state.consecutiveAData == null) {
        return null;
      }

      var aDays = this.state.consecutiveAData;

      var messageBox = /*#__PURE__*/_react["default"].createElement("div", {
        id: "msg-box",
        className: "w3-modal",
        style: {
        ...
        className: "w3-modal-content w3-animate-top"
      }, /*#__PURE__*/_react["default"].createElement("header", {
        className: "w3-container w3-green"
      }, /*#__PURE__*/_react["default"].createElement("h4", null, "\u63D0\u9192")), /*#__PURE__*/_react["default"].createElement("div", {
        className: "w3-container"
      }, /*#__PURE__*/_react["default"].createElement("p", {
        style: {
          "fontSize": "large"
        }
      }, this.state.reminderData.message), /*#__PURE__*/_react["default"].createElement("div", {
        style: {
          "fontSize": "large",
          "textAlign": "center"
        }
      }, /*#__PURE__*/_react["default"].createElement("p", null, "\u5168A(", Math.max.apply(Math, _toConsumableArray(aDays.a_only)), ")\uFF1A", /*#__PURE__*/_react["default"].createElement("span", {
        style: {
          "fontSize": "xx-large"
        }
      }, aDays.a_only[0], ", "), aDays.a_only.slice(1, 6).map(function (day) {
        return /*#__PURE__*/_react["default"].createElement("span", null, day, ", ");
      })), /*#__PURE__*/_react["default"].createElement("p", null, "\u542BA-(", Math.max.apply(Math, _toConsumableArray(aDays.a_minus_included)), ")\uFF1A", /*#__PURE__*/_react["default"].createElement("span", {
        style: {
          "fontSize": "xx-large"
        }
      }, aDays.a_minus_included[0], ", "), aDays.a_minus_included.slice(1, 6).map(function (day) {
        return /*#__PURE__*/_react["default"].createElement("span", null, day, ", ");
      }))), /*#__PURE__*/_react["default"].createElement("p", null, /*#__PURE__*/_react["default"].createElement("button", {
        id: "button-okay",
        onClick: this.handleClickMessageBoxOK,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, messageBox);
    }
  }]);
