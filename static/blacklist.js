...
var Blacklist = /*#__PURE__*/function (_React$Component) {
  ...
  function Blacklist(props) {
    ...
    _this.handleChangeBannedItems = _this.handleChangeBannedItems.bind(_assertThisInitialized(_this));
    _this.handleChangeLimitedItems = _this.handleChangeLimitedItems.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(Blacklist, [{
    key: "handleChangeBannedItems",
    value: function handleChangeBannedItems(event) {
    ...
    key: "handleChangeLimitedItems",
    value: function handleChangeLimitedItems(event) {
      var currentData = this.state.data;
    ...
    value: function fetchDataFromServer() {
      ...
      axios.get('./get-blacklist/').then(function (response) {
        _this2.setState({
    ...
    value: function handleClickUpdate(event) {
      ...
      axios({
        ...
        alert('黑名单更新成功！');
        logUserActivity('[meal-planner] Submit new blacklist', _this3.state.data.metadata.username);
      })["catch"](function (error) {
        console.log(error);
    ...
    value: function render() {
      ...
      }, "\u9ED1\u540D\u5355", /*#__PURE__*/_react["default"].createElement("span", {
        className: "w3-right"
      ...
      }, /*#__PURE__*/_react["default"].createElement("b", null, "\u907F\u514D"), "\u98DF\u7528"), /*#__PURE__*/_react["default"].createElement("textarea", {
        className: "w3-input",
        value: this.state.data.banned_items,
        style: {
          "marginBottom": "2em"
        },
        rows: "3",
        onChange: this.handleChangeBannedItems
      }), /*#__PURE__*/_react["default"].createElement("p", {
        style: {
          color: "#f2552c",
          "marginBottom": "0.2em"
        }
      }, /*#__PURE__*/_react["default"].createElement("b", null, "\u8C28\u614E"), "\u98DF\u7528"), /*#__PURE__*/_react["default"].createElement("textarea", {
        className: "w3-input",
        value: this.state.data.limited_items,
        rows: "3",
        onChange: this.handleChangeLimitedItems
...
},{"./common.js":42,"axios":1,"react":40}],42:[function(require,module,exports){
"use strict";
...
},{"axios":1,"diff-match-patch":35,"react":40}]},{},[41]);
