...
var Notes = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Notes, [{
    ...
    value: function render() {
      ...
      }, "\u5065\u5EB7\u7B14\u8BB0", /*#__PURE__*/React.createElement("span", {
        className: "w3-right"
      ...
      }, "(\u6700\u540E\u66F4\u65B0\uFF1A", new Date(this.state.data.date).toISOString().slice(0, 10), ")"), /*#__PURE__*/React.createElement("button", {
