...
},{"axios":1,"diff-match-patch":35,"react":40}],42:[function(require,module,exports){
"use strict";
...
var Notes = /*#__PURE__*/function (_React$Component) {
  ...
  function Notes(props) {
    ...
    _this.handleClickHistory = _this.handleClickHistory.bind(_assertThisInitialized(_this));
  ...
  _createClass(Notes, [{
    ...
    value: function fetchDataFromServer() {
      ...
      axios.get(this.state.appAddress + 'get-notes/').then(function (response) {
        _this2.setState({
    ...
    value: function handleClickHistory(event) {
    ...
    value: function handleClickUpdate(event) {
      ...
      axios({
        ...
        alert('健康笔记更新成功！');
        logUserActivity('[meal-planner] Submit new notes', _this3.state.data.metadata.username);

        _this3.fetchDataFromServer(); // Must make this call to ensure UI is refreshed.
    ...
    value: function render() {
      ...
      }, "\u5065\u5EB7\u7B14\u8BB0", /*#__PURE__*/_react["default"].createElement("span", {
        className: "w3-right"
      ...
      }, "(\u6700\u540E\u66F4\u65B0\uFF1A", new Date(this.state.data.date).toISOString().slice(0, 10), ")"), /*#__PURE__*/_react["default"].createElement("button", {
        onClick: this.handleClickUpdate,
        className: "w3-button w3-border w3-highway-green w3-right w3-marginBottom input-button"
      }, "\u66F4\u65B0"), /*#__PURE__*/_react["default"].createElement("button", {
...
},{"./common.js":41,"axios":1,"react":40}]},{},[42]);
