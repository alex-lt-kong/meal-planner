    ...
    value: function render() {
      ...
      if (this.state.data.filenames === null) {} else {
        ...
        for (i = 0; i < this.state.data.filenames.length; i++) {
          ...
          var filenameDisplay = /*#__PURE__*/React.createElement("a", {
            href: "javascript:;",
          ...
          if (this.state.enableEdit === true) {
            removeButton = /*#__PURE__*/React.createElement("img", {
              className: "w3-right",
          ...
          if (this.state.enableEdit === true) {
            if (this.state.renameModeFile != this.state.data.filenames[i]) {
              renameButton = /*#__PURE__*/React.createElement("img", {
                className: "w3-right",
                value: this.state.data.filenames[i],
              ...
              renameButton = /*#__PURE__*/React.createElement("button", {
                className: "w3-right",
                onClick: this.handleClickSubmitNewFilename.bind(this, this.state.newFileName)
              }, "\u5B8C\u6210");
              filenameDisplay = /*#__PURE__*/React.createElement("input", {
                type: "text",
                style: {
                  width: "100%"
                },
          ...
          filenames[i] = /*#__PURE__*/React.createElement("li", {
            key: i,
            style: {
              "paddingLeft": "0.2em",
              "paddingRight": "0.2em"
            ...
            value: this.state.data.filenames[i]
          }, filenameDisplay)), /*#__PURE__*/React.createElement("div", {
            className: "w3-container w3-cell"
      ...
      if (this.state.uploadProgress === null) {} else {
        progressBar = /*#__PURE__*/React.createElement("span", null, "\uFF08\u4E0A\u4F20\u8FDB\u5EA6\uFF1A", this.state.uploadProgress, "%\uFF09");
      }

      var uploadButton = null;

      if (this.state.enableUpload === true) {
        uploadButton = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("input", {
...
var MealPlanDailyAttachments = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(MealPlanDailyAttachments, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
        className: "w3-text-green p-mealplanitem-title"
      }, /*#__PURE__*/React.createElement("b", null, "\u9644\u4EF6"))), /*#__PURE__*/React.createElement(AttachmentsManager, {
...
var MealPlanDailySelfie = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(MealPlanDailySelfie, [{
    ...
    value: function render() {
      ...
      if (this.state.enableUpload === true) {
        buttonUpload = /*#__PURE__*/React.createElement("div", {
          style: {
            "marginBottom": "3em"
          }
        }, /*#__PURE__*/React.createElement("button", {
        ...
        }, "\u4E0A\u4F20\u81EA\u62CD"), /*#__PURE__*/React.createElement("input", {
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
        className: "w3-text-green p-mealplanitem-title"
      }, /*#__PURE__*/React.createElement("b", null, "\u81EA\u62CD"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("img", {
  ...
  _createClass(MealPlanDailyRemark, [{
    ...
    value: function render() {
      ...
      if (this.state.data.remark.modification_type == 0) {
        modificationInfo = /*#__PURE__*/React.createElement("span", {
          style: {
            color: 'red',
            fontWeight: 'bold'
          }
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
        className: "w3-text-green p-mealplanitem-title"
      }, /*#__PURE__*/React.createElement("b", null, "\u5907\u6CE8"), modificationInfo)), /*#__PURE__*/React.createElement("div", {
        className: "w3-cell-row"
      }, /*#__PURE__*/React.createElement("div", {
        className: "w3-cell"
  ...
  _createClass(MealPlanItem, [{
    ...
    value: function getFeedbackSelect() {
      ...
      return /*#__PURE__*/React.createElement("select", {
        className: "w3-select",
        style: feedbackStyle,
        value: this.state.data[this.state.itemName].feedback,
    ...
    key: "render",
    value: function render() {
      var modType = this.state.data[this.state.itemName].modification_type;
      var modificationInfo = null;
      var prettyDiff;

      if (modType == 1) {
        modificationInfo = /*#__PURE__*/React.createElement("span", null, " - \u5B89\u5168");
      } else if (modType == 2) {
        modificationInfo = /*#__PURE__*/React.createElement("span", {
          style: {
            color: "red",
        ...
        var previousText = this.state.data[this.state.itemName].prev;
        var currentText = this.state.data[this.state.itemName].content;
        ...
        prettyDiff = /*#__PURE__*/React.createElement("span", {
          style: {
            "marginLeft": "0.5em",
            "fontSize": "12px"
          }
        }, /*#__PURE__*/React.createElement("b", null, "\u5BF9\u7167\uFF1A"), /*#__PURE__*/React.createElement("span", {
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h5", {
        className: "w3-text-green p-mealplanitem-title"
      }, /*#__PURE__*/React.createElement("b", null, this.state.data[this.state.itemName].title), modificationInfo)), /*#__PURE__*/React.createElement("div", {
        className: "w3-cell-row"
      }, /*#__PURE__*/React.createElement("div", {
        className: "w3-cell",
        style: {
        ...
        value: this.state.data[this.state.itemName].content,
        rows: "1",
        readOnly: this.props.sendData == null,
  ...
  _createClass(MealPlan, [{
    ...
    value: function render() {
      ...
      if (parseInt(this.state.id) === 2) {
        ...
        buttonCopyToday = /*#__PURE__*/React.createElement("button", {
          className: "w3-button w3-border w3-highway-green w3-right w3-marginBottom input-button",
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, this.state.convenientDateName, "\u98DF\u8C31(", this.state.date.toISOString().slice(0, 10), ")", /*#__PURE__*/React.createElement("span", {
        className: "w3-right"
      }, this.state.show ? "▴" : "▾")), /*#__PURE__*/React.createElement("div", {
        className: "w3-container w3-card-4 ".concat(this.state.show ? "w3-show" : "w3-hide")
      }, /*#__PURE__*/React.createElement(MealPlanItem, {
        ...
        sendData: this.getData
      }), /*#__PURE__*/React.createElement(MealPlanDailyRemark, {
        data: this.state.data,
        sendData: this.getData
      }), /*#__PURE__*/React.createElement("div", {
        style: {
      ...
      }, "\u63D0\u4EA4"), buttonCopyToday), /*#__PURE__*/React.createElement(MealPlanDailySelfie, {
        data: this.state.data,
        enableUpload: parseInt(this.state.id) === 1,
        date: this.state.date
      }), /*#__PURE__*/React.createElement(MealPlanDailyAttachments, {
...
},{"./attachment.js":37,"./common.js":38,"axios":1}]},{},[39]);
