...
},{"./cjs/react.development.js":38,"./cjs/react.production.min.js":39,"_process":37}],41:[function(require,module,exports){
"use strict";
...
exports.MealPlanDailyAttachments = void 0;
...
var AttachmentsManager = /*#__PURE__*/function (_React$Component) {
  _inherits(AttachmentsManager, _React$Component);

  var _super = _createSuper(AttachmentsManager);

  function AttachmentsManager(props) {
    var _this;

    _classCallCheck(this, AttachmentsManager);
    ...
    _this.onFileUpload = _this.onFileUpload.bind(_assertThisInitialized(_this));
    _this.handleClickFileName = _this.handleClickFileName.bind(_assertThisInitialized(_this));
    _this.handleNewFilenameChange = _this.handleNewFilenameChange.bind(_assertThisInitialized(_this));
    _this.handleClickFileRemove = _this.handleClickFileRemove.bind(_assertThisInitialized(_this));
    _this.handleClickEnableRenameMode = _this.handleClickEnableRenameMode.bind(_assertThisInitialized(_this));
    _this.handleClickSubmitNewFilename = _this.handleClickSubmitNewFilename.bind(_assertThisInitialized(_this));
    _this.onFileChange = _this.onFileChange.bind(_assertThisInitialized(_this));
    _this.handleUploadAttachmentButtonClick = _this.handleUploadAttachmentButtonClick.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(AttachmentsManager, [{
    key: "onFileChange",
    ...
    key: "handleUploadAttachmentButtonClick",
    value: function handleUploadAttachmentButtonClick(event) {
      $('#input-fileupload-attachment').click(); // It is used to apply unified button style to file upload button...
      // It is jQuery...but ...it works!
    }
  }, {
    key: "onFileUpload",
    value: function onFileUpload(selected_file) {
      var _this2 = this;
      ...
      var config = {
        onUploadProgress: function (progressEvent) {
          ...
          if (percentCompleted < 100) this.setState({
      ...
      axios.post("./upload-attachment/", payload, config).then(function (response) {
        ...
        _this2.fetchDataFromServer();
      })["catch"](function (error) {
        console.log(error);
        alert('附件上传错误\n' + error); // You canNOT write error.response or whatever similar here.
    ...
    value: function handleClickFileRemove(value) {
      ...
      axios.get('./remove-attachment/?date=' + this.props.date.toISOString().slice(0, 10) + '&filename=' + value).then(function (response) {
        ...
        logUserActivity('[meal-planner] Remove attachment [' + value + '] from [' + _this3.state.data.metadata.date + ']', _this3.state.data.metadata.username);
      })["catch"](function (error) {
        alert('文件[' + value + ']删除成功失败！\n' + error);
      });
    }
  }, {
    key: "handleClickSubmitNewFilename",
    value: function handleClickSubmitNewFilename(value) {
      ...
      axios.get('./rename-attachment/?date=' + this.props.date.toISOString().slice(0, 10) + '&filename_old=' + this.state.renameModeFile + '&filename_new=' + this.state.newFileName).then(function (response) {
        ...
        _this4.fetchDataFromServer();
      })["catch"](function (error) {
        alert('重命名失败\n' + error);
      });
    }
  }, {
    key: "handleClickEnableRenameMode",
    value: function handleClickEnableRenameMode(value) {
      this.setState({
    ...
    key: "handleNewFilenameChange",
    value: function handleNewFilenameChange(event) {
      this.setState({
    ...
    value: function render() {
      ...
      if (this.state.data.filenames === null) {} else {
        ...
        for (i = 0; i < this.state.data.filenames.length; i++) {
          ...
          var filenameDisplay = /*#__PURE__*/_react["default"].createElement("a", {
            href: "javascript:;",
          ...
          if (this.state.enableEdit === true) {
            if (this.state.renameModeFile != this.state.data.filenames[i]) {
              ...
              renameButton = /*#__PURE__*/_react["default"].createElement("button", {
                className: "w3-right",
                onClick: this.handleClickSubmitNewFilename.bind(this, this.state.newFileName)
              }, "\u5B8C\u6210");
              filenameDisplay = /*#__PURE__*/_react["default"].createElement("input", {
                type: "text",
                style: {
                  width: "100%"
                },
          ...
          filenames[i] = /*#__PURE__*/_react["default"].createElement("li", {
            key: i,
            style: {
              "paddingLeft": "0.2em",
              "paddingRight": "0.2em"
            ...
            value: this.state.data.filenames[i]
          }, filenameDisplay)), /*#__PURE__*/_react["default"].createElement("div", {
            className: "w3-container w3-cell"
      ...
      if (this.state.uploadProgress === null) {} else {
        progressBar = /*#__PURE__*/_react["default"].createElement("span", null, "\uFF08\u4E0A\u4F20\u8FDB\u5EA6\uFF1A", this.state.uploadProgress, "%\uFF09");
      }

      var uploadButton = null;

      if (this.state.enableUpload === true) {
        uploadButton = /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("input", {
          id: "input-fileupload-attachment",
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("ul", {
        className: "w3-ul"
      }, filenames), uploadButton, progressBar);
    }
  }]);
...
var MealPlanDailyAttachments = /*#__PURE__*/function (_React$Component2) {
  _inherits(MealPlanDailyAttachments, _React$Component2);

  var _super2 = _createSuper(MealPlanDailyAttachments);

  function MealPlanDailyAttachments(props) {
    var _this6;

    _classCallCheck(this, MealPlanDailyAttachments);
  ...
  _createClass(MealPlanDailyAttachments, [{
    key: "render",
    value: function render() {
  ...
  return MealPlanDailyAttachments;
}(_react["default"].Component);

exports.MealPlanDailyAttachments = MealPlanDailyAttachments;

},{"axios":1,"react":40}],42:[function(require,module,exports){
"use strict";
...
exports.MealPlanItem = exports.MealPlanDailySelfie = exports.MealPlanDailyRemark = void 0;
exports.textAreaAdjust = textAreaAdjust;
...
function textAreaAdjust() {
  return _textAreaAdjust.apply(this, arguments);
}

function _textAreaAdjust() {
  _textAreaAdjust = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            $('textarea').each(function () {
              ...
              $(this)[0].style.height = 2 + $(this)[0].scrollHeight + "px"; // 1+ seems not enough in some cases, try 2+
            });
...
var MealPlanDailySelfie = /*#__PURE__*/function (_React$Component) {
  _inherits(MealPlanDailySelfie, _React$Component);

  var _super = _createSuper(MealPlanDailySelfie);

  function MealPlanDailySelfie(props) {
    var _this;

    _classCallCheck(this, MealPlanDailySelfie);
    ...
    _this.onFileChange = _this.onFileChange.bind(_assertThisInitialized(_this));
    _this.handleUploadSelfieButtonClick = _this.handleUploadSelfieButtonClick.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(MealPlanDailySelfie, [{
    key: "handleUploadSelfieButtonClick",
    value: function handleUploadSelfieButtonClick(event) {
      $('#input-fileupload-selfie').click(); // It is used to apply unified button style to file upload button...
      // It is jQuery...but ...it works!
    }
  }, {
    key: "onFileChange",
    ...
    value: function onFileUpload(selected_file) {
      ...
      axios.post("./upload-selfie/", payload).then(function (response) {
        // an alert is not needed since the user will see the change of the thumbnail.
        console.log('eal-planner] Upload selfi');
        logUserActivity('[meal-planner] Upload selfie', _this2.state.data.metadata.username);

        _this2.forceUpdate(); // This forceUpdate() is needed so that the new image will be shown
    ...
    value: function render() {
      ...
      if (this.props.enableUpload === true) {
        ...
        }, "\u4E0A\u4F20\u81EA\u62CD"), /*#__PURE__*/_react["default"].createElement("input", {
          id: "input-fileupload-selfie",
          onChange: this.onFileChange,
          type: "file",
          style: {
            display: "none"
  ...
  return MealPlanDailySelfie;
}(_react["default"].Component);

exports.MealPlanDailySelfie = MealPlanDailySelfie;

var MealPlanDailyRemark = /*#__PURE__*/function (_React$Component2) {
  _inherits(MealPlanDailyRemark, _React$Component2);

  var _super2 = _createSuper(MealPlanDailyRemark);

  function MealPlanDailyRemark(props) {
    var _this3;

    _classCallCheck(this, MealPlanDailyRemark);
  ...
  _createClass(MealPlanDailyRemark, [{
    key: "handleChange",
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("p", {
        className: "w3-text-green p-mealplanitem-title"
      }, /*#__PURE__*/_react["default"].createElement("b", null, "\u5907\u6CE8"), modificationInfo)), /*#__PURE__*/_react["default"].createElement("div", {
        className: "w3-cell-row"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "w3-cell"
  ...
  return MealPlanDailyRemark;
}(_react["default"].Component);

exports.MealPlanDailyRemark = MealPlanDailyRemark;

var MealPlanItem = /*#__PURE__*/function (_React$Component3) {
  _inherits(MealPlanItem, _React$Component3);

  var _super3 = _createSuper(MealPlanItem);

  function MealPlanItem(props) {
    var _this4;

    _classCallCheck(this, MealPlanItem);
  ...
  _createClass(MealPlanItem, [{
    ...
    value: function handleFeedbackChange(event) {
      var currentData = this.state.data;
    ...
    key: "getFeedbackSelect",
    value: function getFeedbackSelect() {
      var optionsValueList = ['A - 大便成形，饮食正常量，无饱胀/腹痛/不适', 'B - 大便不成形', 'B - 饮食减量', 'B - 轻微腹痛或轻微不适', 'C - 拉稀', 'C - 饮食较大减量', 'C - 腹痛或较严重不适', '待填'];
      ...
      for (var i = 0; i < optionsValueList.length; i++) {
        optionsList.push( /*#__PURE__*/_react["default"].createElement("option", {
          className: "w3-text-black",
          key: i,
          value: optionsValueList[i]
        }, optionsValueList[i]));
      }
      ...
      return /*#__PURE__*/_react["default"].createElement("select", {
        className: "w3-select",
        style: feedbackStyle,
        value: this.props.data[this.props.itemName].feedback,
    ...
    value: function render() {
      ...
      if (modType == 1) {
        modificationInfo = /*#__PURE__*/_react["default"].createElement("span", null, " - \u5B89\u5168");
      } else if (modType == 2) {
        modificationInfo = /*#__PURE__*/_react["default"].createElement("span", {
          style: {
            color: "red",
        ...
        var previousText = this.props.data[this.props.itemName].prev;
        var currentText = this.props.data[this.props.itemName].content;
        ...
        prettyDiff = /*#__PURE__*/_react["default"].createElement("span", {
          style: {
            "marginLeft": "0.5em",
            "fontSize": "12px"
          }
        }, /*#__PURE__*/_react["default"].createElement("b", null, "\u5BF9\u7167\uFF1A"), /*#__PURE__*/_react["default"].createElement("span", {
          dangerouslySetInnerHTML: {
            __html: dmp.diff_prettyHtml(diff)
          }
        }));
      }

      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("h5", {
        className: "w3-text-green p-mealplanitem-title"
      }, /*#__PURE__*/_react["default"].createElement("b", null, this.props.data[this.props.itemName].title), modificationInfo)), /*#__PURE__*/_react["default"].createElement("div", {
        className: "w3-cell-row"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "w3-cell",
        style: {
        ...
        className: "w3-input textarea-mealplanitem",
        value: this.props.data[this.props.itemName].content,
        rows: "1",
        readOnly: this.props.sendData == null,
      ...
      }, this.getFeedbackSelect())), prettyDiff);
    }
  }]);
...
},{"axios":1,"diff-match-patch":35,"react":40}],43:[function(require,module,exports){
"use strict";
...
var textAreaAdjust = require('./common.js').textAreaAdjust;
...
var MealPlan = /*#__PURE__*/function (_React$Component) {
  _inherits(MealPlan, _React$Component);

  var _super = _createSuper(MealPlan);
  ...
  function MealPlan(props) {
    ...
    _this.state = {
      ...
      /* Will be initialized in componentDidMount() */
      date: props.date,
      id: props.id,
      show: props.show,
      userName: null
    ...
    _this.handleAccordionClick = _this.handleAccordionClick.bind(_assertThisInitialized(_this));
    _this.handleCopyTodayClick = _this.handleCopyTodayClick.bind(_assertThisInitialized(_this));
  ...
  _createClass(MealPlan, [{
    ...
    value: function fetchDataFromServer() {
      ...
      axios.get(this.state.appAddress + '/get-meal-plan/?date=' + this.state.date.toISOString().slice(0, 10)).then(function (response) {
        // handle success
        _this2.setState({
          data: null // make it empty before fill it in again to force a re-rendering.
        ...
        alert(_this2.state.date.toISOString().slice(0, 10) + '的食谱项目加载失败！请关闭窗口后重试！\n' + error);
      });
    }
  }, {
    key: "handleCopyTodayClick",
    value: function handleCopyTodayClick(event) {
      var _this3 = this;

      var today = new Date(this.state.date);
      today.setDate(today.getDate() - 1);
      axios.get(this.state.appAddress + 'get-meal-plan/?date=' + today.toISOString().slice(0, 10)).then(function (response) {
        // handle success
        _this3.setState({
          data: null // You have to make some drastic change. i.e., make the reference different, to
    ...
    value: function handleAccordionClick(event) {
      this.setState(function (prevState) {
        return {
          show: !prevState.show
        };
      });
      textAreaAdjust(); // textAreaAdjust() has to be called twice. 
      // This call adjusts the height of textareas after accordion expansion.
    }
  }, {
    key: "handleClickUpdate",
    value: function handleClickUpdate(event) {
      var _this4 = this;
      ...
      axios({
        ...
        alert(_this4.state.date.toISOString().slice(0, 10) + '的食谱更新成功！');

        _this4.fetchDataFromServer(); // Must make this call to ensure UI is refreshed.


        logUserActivity('[meal-planner] Submit plan of ' + _this4.state.data.metadata.date, _this4.state.data.metadata.username);
      })["catch"](function (error) {
        console.log(error);
        alert('错误：\n' + error); // You canNOT write error.response or whatever similar here.
        // The reason is that this catch() catches both network error and other errors,
    ...
    value: function render() {
      ...
      if (parseInt(this.state.id) === 2) {
        ...
        buttonCopyToday = /*#__PURE__*/_react["default"].createElement("button", {
          className: "w3-button w3-border w3-highway-green w3-right w3-marginBottom input-button",
          onClick: this.handleCopyTodayClick
        }, "\u6CBF\u7528\u4ECA\u65E5");
      }
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, this.state.convenientDateName, "\u98DF\u8C31(", this.state.date.toISOString().slice(0, 10), ")", /*#__PURE__*/_react["default"].createElement("span", {
        className: "w3-right"
      }, this.state.show ? "▴" : "▾")), /*#__PURE__*/_react["default"].createElement("div", {
        className: "w3-container w3-card-4 ".concat(this.state.show ? "w3-show" : "w3-hide")
      }, /*#__PURE__*/_react["default"].createElement(MealPlanItem, {
        data: this.state.data,
        itemName: "breakfast",
        sendData: this.getData
      }), /*#__PURE__*/_react["default"].createElement(MealPlanItem, {
        data: this.state.data,
        itemName: "morning_extra_meal",
        sendData: this.getData
      }), /*#__PURE__*/_react["default"].createElement(MealPlanItem, {
        data: this.state.data,
        itemName: "lunch",
        ...
        data: this.state.data,
        itemName: "evening_extra_meal",
        sendData: this.getData
      }), /*#__PURE__*/_react["default"].createElement(MealPlanDailyRemark, {
        data: this.state.data,
        sendData: this.getData
      }), /*#__PURE__*/_react["default"].createElement("div", {
        style: {
      ...
      }, "\u63D0\u4EA4"), buttonCopyToday), /*#__PURE__*/_react["default"].createElement(MealPlanDailySelfie, {
        data: this.state.data,
        enableUpload: parseInt(this.state.id) === 1,
        date: this.state.date
      }), /*#__PURE__*/_react["default"].createElement(MealPlanDailyAttachments, {
        enableEdit: parseInt(this.state.id) === 1,
        enableUpload: parseInt(this.state.id) === 1,
        date: this.state.date
      })));
    }
...
},{"./attachment.js":41,"./common.js":42,"axios":1,"react":40}]},{},[43]);
